...
export function ProfileCard(props: ProfileCardProps) {
  ...
  return (
    ...
    >
      <Card className="relative overflow-hidden border-2 text-white border-cyan-400/50 bg-slate-900/70 backdrop-blur-md shadow-lg shadow-cyan-400/20 rounded-lg">
        {/* holographic edge */}
        ...
        <CardContent className="relative p-6 md:p-8">
          <div className="flex items-center gap-4">
                ...
                <div className="size-full rounded-full bg-background grid place-items-center">
                  {avatarUrl ? (
                    ...
                    <img
                      src={
                        avatarUrl ||
                        "/placeholder.svg?height=64&width=64&query=holographic%20avatar"
                      }
                      alt="Avatar"
            ...
            <div className="min-w-0">
              ...
              <Badge
                variant="outline"
                className="border-cyan-400/50 text-cyan-200 bg-cyan-400/10"
              >
                {displayRole}
              </Badge>
            </div>
          ...
          <p className="mt-4 text-pretty text-sm md:text-base text-white">
            {subtitle}
          </p>
        </CardContent>
      </Card>
